...
function WeDo() {
  // Define animation variants once
  const variants = {
  ...
  return (
    // The overflow-x: hidden on this div in CSS solves the scrollbar issue
      ...
      <div className={style.containerAll}>
        <div className={style.containerTitleDescription}>
          ...
          <motion.div
            ...
            initial="hidden"
            whileInView="visible" // Use whileInView to trigger animation
